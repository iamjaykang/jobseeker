...
export type AddJobPostSuccess = Action<JOB_POSTS_ACTION_TYPES.ADD_JOB_POST_SUCCESS>;

export type AddJobPostFailed = Action<JOB_POSTS_ACTION_TYPES.ADD_JOB_POST_FAILED>;
...
export type UpdateJobPostSuccess = Action<JOB_POSTS_ACTION_TYPES.UPDATE_JOB_POST_SUCCESS>;

export type UpdateJobPostFailed = Action<JOB_POSTS_ACTION_TYPES.UPDATE_JOB_POST_FAILED>;
...
export type DeleteJobPostSuccess = Action<JOB_POSTS_ACTION_TYPES.DELETE_JOB_POST_SUCCESS>;

export type DeleteJobPostFailed = Action<JOB_POSTS_ACTION_TYPES.DELETE_JOB_POST_FAILED>;
...
export const fetchAllJobPostsSuccess = withMatcher(
  (jobPostsArray: JobPost[]): FetchAllJobPostsSuccess =>
    createAction(JOB_POSTS_ACTION_TYPES.FETCH_ALL_JOB_POSTS_SUCCESS, jobPostsArray)
);
...
export const fetchJobPostByIdSuccess = withMatcher(
  (jobPostData: JobPost): FetchJobPostByIdSuccess =>
    createAction(JOB_POSTS_ACTION_TYPES.FETCH_JOB_POST_BY_ID_SUCCESS, jobPostData)
);
...
export const addJobPostLoading = withMatcher(
  (jobPostFormData: JobPostFormValues): AddJobPostLoading => {
    jobPostFormData;
    return createAction(JOB_POSTS_ACTION_TYPES.ADD_JOB_POST_LOADING, jobPostFormData);
  }
);

// Action to add JOBS success
export const addJobPostSuccess = withMatcher(
  (): AddJobPostSuccess => createAction(JOB_POSTS_ACTION_TYPES.ADD_JOB_POST_SUCCESS)
);

// Action to add JOBS failed
export const addJobPostFailed = withMatcher(
  (): AddJobPostFailed => createAction(JOB_POSTS_ACTION_TYPES.ADD_JOB_POST_FAILED)
);
...
export const updateJobPostSuccess = withMatcher(
  (): UpdateJobPostSuccess => createAction(JOB_POSTS_ACTION_TYPES.UPDATE_JOB_POST_SUCCESS)
);

// Action to update JOBS failed
export const updateJobPostFailed = withMatcher(
  (): UpdateJobPostFailed => createAction(JOB_POSTS_ACTION_TYPES.UPDATE_JOB_POST_FAILED)
);
...
export const deleteJobPostSuccess = withMatcher(
  (): DeleteJobPostSuccess => createAction(JOB_POSTS_ACTION_TYPES.DELETE_JOB_POST_SUCCESS)
);

// Action to delete JOB failed
export const deleteJobPostFailed = withMatcher(
  (): DeleteJobPostFailed => createAction(JOB_POSTS_ACTION_TYPES.DELETE_JOB_POST_FAILED)
);
